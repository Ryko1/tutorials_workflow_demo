...
# Integration Testing   --determine whether multiple components in an application are able to integrate with one another
#NOTE: Pytest must have access to the database in order to run test ('@pytest.mark.django_db' decorator)
...
def test_compare_tutorials(new_tutorial, another_tutorial):
    assert new_tutorial.pk != another_tutorial.pk   #--'pk' refers to the primary key in the Django ORM
